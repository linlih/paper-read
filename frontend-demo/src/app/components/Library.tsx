                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      {paper.status === 'processing' && (
                        <span className="text-xs px-2 py-0.5 rounded bg-yellow-100 text-yellow-700">{t.processing}</span>
                      )}
                    </div>
                    ...
                    <p className="text-[#7A7165] text-sm mb-3 line-clamp-1">{paper.authors.join(', ')}</p>
                    ...
                    <div className="flex items-center gap-3 flex-wrap">
                      ...
                      <span className="flex items-center gap-1 text-xs text-[#7A7165] ml-auto">
                        <Clock size={11} />{formatDate(paper.uploadedAt)}
                      </span>
                    </div>
                  </div>
